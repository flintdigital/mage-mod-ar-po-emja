<?php
class EmjaInteractive_PurchaseorderManagement_Model_Mysql4_Report_Order
    extends Mage_Sales_Model_Mysql4_Report_Order
{
    /* (non-PHPdoc)
    ...
    public function aggregate($from = null, $to = null)
    {
        ...
        try {
            ...
            $columns = array(
                ...
                'net_terms'                      => 'GROUP_CONCAT(DISTINCT o.net_terms)'
            );
            ...
            $columns['net_terms']      = 'GROUP_CONCAT(DISTINCT net_terms)';
